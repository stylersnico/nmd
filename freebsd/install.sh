...
wget --no-check-certificate -q -O /usr/local/nmd/scripts/ban.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/ban.sh
echo -n '.'
chmod 0755 /usr/local/nmd/scripts/ban.sh

wget --no-check-certificate -q -O /usr/local/nmd/scripts/default-config.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/default-config.sh
echo -n '.'
chmod 0755 /usr/local/nmd/scripts/default-config.sh

wget --no-check-certificate -q -O /usr/local/nmd/scripts/error.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/error.sh
echo -n '.'
chmod 0755 /usr/local/nmd/scripts/error.sh

wget --no-check-certificate -q -O /usr/local/nmd/scripts/reset-log.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/reset-log.sh
echo -n '.'
chmod 0755 /usr/local/nmd/scripts/reset-log.sh

wget --no-check-certificate -q -O /usr/local/nmd/scripts/show-ban.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/show-ban.sh
echo -n '.'
chmod 0755 /usr/local/nmd/scripts/show-ban.sh

wget --no-check-certificate -q -O /usr/local/nmd/scripts/unban.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/scripts/unban.sh
echo -n '.'
...
wget --no-check-certificate -q -O /usr/local/nmd/white-list/white-list.sh https://raw.githubusercontent.com/stylersnico/nmd/master/debian/white-list/white-list.sh
echo -n '.'
chmod 0755 /usr/local/nmd/white-list/white-list.sh

wget --no-check-certificate -q -O /usr/local/nmd/white-list/white.list https://raw.githubusercontent.com/stylersnico/nmd/master/debian/white-list/white.list
echo -n '.'
chmod 0755 /usr/local/nmd/white-list/white.list

#Installing base system
echo; echo -n 'Downloading base system...'
wget --no-check-certificate -q -O /usr/local/nmd/nmd https://raw.githubusercontent.com/stylersnico/nmd/master/debian/nmd
echo -n '.'
